package com.hfliveplayer.sdk.demo.view;
...
public class HifiveFlowLayout extends ViewGroup {

    public HifiveFlowLayout(Context context) {
        super(context);
    }

    public HifiveFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HifiveFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
