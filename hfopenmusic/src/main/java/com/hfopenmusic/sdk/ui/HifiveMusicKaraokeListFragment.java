...
//import com.hfopenmusic.sdk.ui.player.HFOpenMusic;
...
//                            HFOpenMusic.getInstance().setKaraokeList(hifiveMusicModels);
//                        }else{
...
//                        HFOpenMusic.getInstance().setKaraokeList(adapter.getDatas());
...
//                        HFOpenMusic.getInstance().addCurrentSingle(getActivity(),hifiveMusicModel,"1");
//                        break;
//                }
//            } catch (Exception e) {
//                e.printStackTrace();
...
//        if(getActivity() != null)
//            sheetId = HFOpenMusic.getInstance().getUserSheetIdByName(getActivity().getString(R.string.hifivesdk_music_karaoke));
//        initView(view);
//        initRecyclerView();
//        if(HFOpenMusic.getInstance().getKaraokeList() !=null
//                && HFOpenMusic.getInstance().getKaraokeList().size() >0){
//            hifiveMusicModels = HFOpenMusic.getInstance().getKaraokeList();
...
//                HFOpenMusic.getInstance().updateCurrentList(getActivity(), (List<HifiveMusicModel>)adapter.getDatas());
//            }
//        });
//
...
//                            HFOpenMusic.getInstance().showToast(getActivity(),string);
//                        }
//
//                        @Override
...
//            if (HFLiveApi.getInstance() == null || getContext() == null)
//                return;
//            HFLiveApi.getInstance().getMemberSheetMusicList(getContext(), String.valueOf(sheetId), null, HFOpenMusic.field,
...
//                    adapter.notifyDataSetChanged();
//                }else if(type == HFOpenMusic.UPDATEKARAOKLIST){
//                    hifiveMusicModels = HFOpenMusic.getInstance().getKaraokeList();
//                    if (hifiveMusicModels.size() > 0) {
//                        adapter.addHeaderView(R.layout.hifive_header_playall);
//                        adapter.updateDatas(hifiveMusicModels);
