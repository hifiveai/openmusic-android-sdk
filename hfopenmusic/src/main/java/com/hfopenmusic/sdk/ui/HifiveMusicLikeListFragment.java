...
//                            HFOpenMusic.getInstance().setLikeList(hifiveMusicModels);
//                        }else{
...
//                        }
//                        HFOpenMusic.getInstance().setLikeList(adapter.getDatas());
...
//                        HFOpenMusic.getInstance().addCurrentSingle(getActivity(),hifiveMusicModel,"2");
//                        break;
//                }
//            } catch (Exception e) {
//                e.printStackTrace();
...
//        if(getActivity() != null)
//            sheetId = HFOpenMusic.getInstance().getUserSheetIdByName(getActivity().getString(R.string.hifivesdk_music_like));
//        initView(view);
//        initRecyclerView();
//        if(HFOpenMusic.getInstance().getLikeList() !=null
//                && HFOpenMusic.getInstance().getLikeList().size() >0){
//            hifiveMusicModels = HFOpenMusic.getInstance().getLikeList();
...
//                    adapter.notifyDataSetChanged();
//                }else if(type == HFOpenMusic.UPDATELIKELIST){
//                    hifiveMusicModels = HFOpenMusic.getInstance().getLikeList();
//                    if (hifiveMusicModels.size() > 0) {
//                        adapter.addHeaderView(R.layout.hifive_header_playall);
//                        adapter.updateDatas(hifiveMusicModels);
