...
import com.hfopenplayer.sdk.adapter.HifiveHotMusicAdapter
...
import com.hfopenplayer.sdk.util.SharedPref
import com.hfopenplayer.sdk.view.HifiveFlowLayout
...
class HifiveMusicSearchDialoglFragment() : DialogFragment() {
    ...
    private fun ininReclyView() {
        ...
        adapter!!.setOnRecyclerViewContentClick {
        ...
        hotAdapter!!.setOnRecyclerViewContentClick { }
